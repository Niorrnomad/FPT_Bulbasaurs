...
create_rc_corner -name rc_typ\
   ...
   -preRoute_clkres 0\
   -preRoute_clkcap 0\
   -qx_tech_file ${::IMEX::libVar}/mmmc/rc_typ/gpdk045.tch
create_rc_corner -name lmao\
   -preRoute_res 1\
   -postRoute_res 1\
   -preRoute_cap 1\
   -postRoute_cap 1\
...
create_analysis_view -name apb -constraint_mode m -delay_corner max_delay -latency_file ${::IMEX::dataVar}/mmmc/views/apb/latency.sdc
