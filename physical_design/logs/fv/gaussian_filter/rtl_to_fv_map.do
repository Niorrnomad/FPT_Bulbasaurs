...
# Generated on: Sat Mar 28 14:44:19 +07 2026 (Sat Mar 28 07:44:19 UTC 2026)
...
set logfile fv/gaussian_filter/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/gaussian_filter -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/home/niorr/cadence/installs/DDI251/GENUS251/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/niorr/cadence/installs/DDI251/GENUS251/tools.lnx86"
set env(CW_DIR) "/home/niorr/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware"
set CW_DIR      "/home/niorr/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/niorr/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/niorr/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/niorr/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/niorr/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/niorr/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
}
...
add_search_path . /home/niorr/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/tech -library -both
read_library -liberty -both \
    /home/niorr/adder_rtl/lib/gsclib045_all_v4.8/gsclib045/timing/slow_vdd1v0_basicCells.lib
...
add_search_path /home/niorr/FPT_Bulbasaurs/physical_design/gaussian_camera.v -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/niorr/FPT_Bulbasaurs/physical_design/gaussian_camera.v
elaborate_design -golden -root {gaussian_filter} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/gaussian_filter/fv_map.v.gz
elaborate_design -revised -root {gaussian_filter}
...
set_analyze_option -mapping_file fv/gaussian_filter/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.gaussian_filter.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.gaussian_filter.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.gaussian_filter.rtl.fv_map.rpt
